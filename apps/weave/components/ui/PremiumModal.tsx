...
export const PremiumModal: React.FC<PremiumModalProps> = ({ 
  ...
  return (
    ...
    >
      <div 
        className={`${width} w-full glass-panel border border-zinc-200 dark:border-white/10 rounded-2xl shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200 overflow-hidden bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl`}
