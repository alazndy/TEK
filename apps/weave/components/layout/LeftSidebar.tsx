...
export const LeftSidebar: React.FC<LeftSidebarProps> = ({
  ...
  const renderTemplateCard = (template: ProductTemplate) => (
    <div
      ...
      className="group relative bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-xl p-2.5 cursor-grab active:cursor-grabbing hover:border-paprika/40 hover:bg-zinc-50 dark:hover:bg-white/10 hover:shadow-lg hover:shadow-paprika/5 transition-all duration-200 active:scale-95 overflow-hidden backdrop-blur-sm"
      title={template.name}
    >
      ...
      <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-all duration-200 translate-x-2 group-hover:translate-x-0 z-20">
        <button
          ...
          className="bg-zinc-800 dark:bg-black/80 text-zinc-100 dark:text-zinc-300 p-1.5 rounded-lg shadow-lg hover:bg-apricot hover:text-black border border-white/10 backdrop-blur-md"
        ...
        <button
          ...
          className="bg-zinc-800 dark:bg-black/80 text-zinc-100 dark:text-zinc-300 p-1.5 rounded-lg shadow-lg hover:bg-red-600 hover:text-white border border-white/10 backdrop-blur-md"
      ...
      <div className="aspect-square w-full bg-zinc-50 dark:bg-black/20 rounded-lg mb-3 p-2 flex items-center justify-center overflow-hidden border border-zinc-200 dark:border-white/5 border-dashed group-hover:border-paprika/20 transition-colors">
        <img
      ...
      {template.isBlock ? (
        ...
        <div className="absolute top-2 left-2">
          <span className="text-[9px] font-bold text-zinc-500 bg-white/80 dark:bg-black/60 px-1.5 py-0.5 rounded border border-zinc-200 dark:border-white/5 group-hover:border-paprika/20 group-hover:text-paprika transition-colors shadow-sm backdrop-blur-sm">
  ...
  return (
    <div
      className={`relative h-full transition-all duration-300 ease-in-out flex flex-col z-30 no-print ${
        isOpen
          ? "w-80 glass-panel border-r border-zinc-200 dark:border-white/20 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl"
          : "w-0 border-none"
      }`}
    >
      {/* Toggle Button */}
      <button
        ...
        className="absolute -right-8 top-6 glass-panel border-l-0 bg-white/80 dark:bg-zinc-900/80 text-zinc-500 dark:text-zinc-400 hover:text-paprika p-1.5 rounded-r-lg shadow-lg cursor-pointer z-50 flex items-center justify-center h-10 w-8 transition-colors border-zinc-200 dark:border-white/20"
      ...
      >
        ...
        <div className="p-6 border-b border-zinc-200/50 dark:border-white/5">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 bg-zinc-100 dark:bg-white/5 hover:bg-paprika/10 text-zinc-700 dark:text-alabaster hover:text-paprika py-2.5 rounded-xl text-xs font-bold flex justify-center items-center gap-2 border border-zinc-200 dark:border-white/10 transition-all active:scale-95 shadow-sm"
            >
              <Save size={14} /> {t('sidebar.save')}
            </button>
            <button
              onClick={() => projectInputRef.current?.click()}
              className="flex-1 bg-zinc-100 dark:bg-white/5 hover:bg-apricot/10 text-zinc-700 dark:text-alabaster hover:text-apricot py-2.5 rounded-xl text-xs font-bold flex justify-center items-center gap-2 border border-zinc-200 dark:border-white/10 transition-all active:scale-95 shadow-sm"
            >
          ...
          <div className="mt-2 space-y-2">
            {onOpenProjectBoard && (
                ...
                className="w-full bg-purple-500/10 hover:bg-purple-500/20 text-purple-600 dark:text-purple-400 hover:text-purple-500 py-2.5 rounded-xl text-xs font-bold flex justify-center items-center gap-2 border border-purple-500/20 transition-all active:scale-95 shadow-sm"
                >
                <KanbanSquare size={14} /> {t('sidebar.projectBoard') || "Proje Panosu"}
                </button>
            )}
            {onOpenUPHExport && (
                <button
        ...
        {/* Library Selector */}
        <div className="p-4 bg-white/50 dark:bg-white/5 border-b border-zinc-200/50 dark:border-white/5">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5 custom-scrollbar bg-gradient-to-b from-transparent to-zinc-50 dark:to-black/20">
          ...
          {templates.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-12 text-zinc-600 border border-dashed border-zinc-200 dark:border-white/10 rounded-2xl bg-zinc-50 dark:bg-white/5">
        ...
        <div className="p-2 bg-zinc-100 dark:bg-black/40 text-[9px] font-medium text-zinc-500 dark:text-zinc-700 text-center border-t border-zinc-200 dark:border-white/5">
          {t('sidebar.footer')}
        </div>
      </div>
      ...
      {contextMenu && (
        ...
        >
          <button
            className="w-full px-4 py-2 text-left text-sm text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-white/10 hover:text-zinc-900 dark:hover:text-white flex items-center gap-2"
