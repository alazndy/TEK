...
const ProjectBoardModal = React.lazy(() => import('../modals/ProjectBoardModal').then(module => ({ default: module.ProjectBoardModal })));
...
interface ModalManagerProps {
  ...
  setIsProjectBoardOpen: (open: boolean) => void;
  ...
  return (
    <>
      <Suspense fallback={
        ...
        {isProjectBoardOpen && <ProjectBoardModal
            isOpen={isProjectBoardOpen}
            onClose={() => setIsProjectBoardOpen(false)}
        />}
