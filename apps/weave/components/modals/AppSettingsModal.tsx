    ...
    >
        <div className="space-y-8">
            ...
            <section>
                ...
                <TeamMemberInput settings={settings} onUpdateSettings={onUpdateSettings} />
            </section>
        </div>
    </PremiumModal>
  );
...
const TeamMemberInput: React.FC<{ settings: AppSettings, onUpdateSettings: (s: AppSettings) => void }> = ({ settings, onUpdateSettings }) => {
    const [name, setName] = React.useState('');
    const [email, setEmail] = React.useState('');
    const [role, setRole] = React.useState<'viewer' | 'manager' | 'admin'>('viewer');
