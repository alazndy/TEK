  ...
  const headerContent = (
      <div className="flex items-center gap-3">
          {isOnline ? (
              ...
              <span className="flex items-center text-xs font-bold text-zinc-500 bg-zinc-200 dark:bg-zinc-800/50 px-2 py-1 rounded-full border border-zinc-300 dark:border-zinc-700">
  ...
  return (
    ...
    >
        <div className="flex flex-col h-[500px]">
            {/* Status Bar */}
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-500/5 to-transparent rounded-xl border border-blue-500/10 mb-6">
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-white dark:bg-black/20 rounded-full border border-zinc-200 dark:border-white/5">
                        {getStatusIcon()}
                    </div>
                    <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300">{getStatusText()}</span>
                </div>
                <button
            ...
            {/* Tabs */}
            <div className="flex gap-4 mb-6 border-b border-zinc-200 dark:border-white/5 pb-1">
                <button
                ...
                {activeTab === 'projects' ? (
                    <div className="space-y-3">
                        {cloudProjects.length === 0 ? (
                            <div className="flex flex-col items-center justify-center h-64 text-zinc-500 border-2 border-dashed border-zinc-200 dark:border-white/5 rounded-2xl bg-zinc-50/50 dark:bg-white/[0.02]">
                                <div className="p-4 bg-zinc-100 dark:bg-white/5 rounded-full mb-4">
                            ...
                            cloudProjects.map((project) => (
                                <div
                                    key={project.id}
                                    className="group flex items-center justify-between p-4 bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/5 rounded-xl hover:bg-white dark:hover:bg-white/10 hover:border-zinc-300 dark:hover:border-white/10 transition-all cursor-default shadow-sm"
                                >
                                    <div className="flex-1">
                                        <h4 className="font-bold text-zinc-800 dark:text-zinc-200 group-hover:text-black dark:group-hover:text-white transition-colors flex items-center gap-2">
                                            {project.name}
                    ...
                    <div className="space-y-4">
                        <div className="p-5 bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/5 rounded-2xl">
                             <h3 className="text-sm font-bold text-zinc-800 dark:text-white mb-4">Senkronizasyon Tercihleri</h3>
                             
                             <div className="space-y-4">
                                <label className="flex items-center justify-between p-3 bg-white dark:bg-black/20 rounded-xl cursor-pointer border border-zinc-200 dark:border-transparent hover:bg-zinc-50 dark:hover:bg-black/30 transition-colors group">
                                    <div>
                                        <span className="block text-sm font-bold text-zinc-700 dark:text-zinc-300 group-hover:text-black dark:group-hover:text-white">Otomatik Senkronizasyon</span>
                                ...
                                <label className="flex items-center justify-between p-3 bg-white dark:bg-black/20 rounded-xl cursor-pointer border border-zinc-200 dark:border-transparent hover:bg-zinc-50 dark:hover:bg-black/30 transition-colors group">
                                    <div>
                                        <span className="block text-sm font-bold text-zinc-700 dark:text-zinc-300 group-hover:text-black dark:group-hover:text-white">Çevrimdışı Mod</span>
                                ...
                                <label className="flex items-center justify-between p-3 bg-white dark:bg-black/20 rounded-xl cursor-pointer border border-zinc-200 dark:border-transparent hover:bg-zinc-50 dark:hover:bg-black/30 transition-colors group">
                                    <div>
                                        <span className="block text-sm font-bold text-zinc-700 dark:text-zinc-300 group-hover:text-black dark:group-hover:text-white">Çakışma Çözümü</span>
                                    ...
                                    <select
                                        ...
                                        className="bg-zinc-100 dark:bg-black/40 border border-zinc-200 dark:border-white/10 rounded-lg px-3 py-1.5 text-xs text-zinc-800 dark:text-white outline-none focus:border-blue-500 font-bold"
                                    >
                        ...
                        <div className="p-4 rounded-xl bg-blue-500/5 border border-blue-500/10">
                            <h4 className="text-xs font-bold text-blue-600 dark:text-blue-300 mb-2 flex items-center gap-2"><Upload className="h-3 w-3"/> Depolama Durumu</h4>
                            <div className="w-full bg-zinc-200 dark:bg-black/40 rounded-full h-2 mb-2 overflow-hidden">
