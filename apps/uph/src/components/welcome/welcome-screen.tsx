          ...
          <div className="w-[40%] bg-muted/30 p-10 flex flex-col justify-between border-r border-border">
            <div>
              ...
              <div className="mb-10">
                ...
                <p className="text-muted-foreground font-medium">Unified Project Hub</p>
              ...
              <div className="space-y-3">
                ...
                <Button 
                  ...
                  className="w-full h-12 justify-start pl-6 text-base hover:bg-accent hover:text-accent-foreground text-foreground rounded-xl group"
                >
                  <Package className="w-5 h-5 mr-3 text-primary group-hover:scale-110 transition-transform" />
                  Envanter
                </Button>
              ...
              {lowStockItems > 0 && (
                <div className="mt-4 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-amber-500">{lowStockItems} düşük stoklu ürün</p>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar -mr-4 pr-4">
              {recentProjects.length > 0 ? (
                <div className="space-y-3">
                  {recentProjects.map((project, idx) => (
                    <motion.div 
                      ...
                      className="group p-4 rounded-xl bg-muted/30 border border-border/40 hover:bg-muted/50 hover:border-border transition-all cursor-pointer flex items-center gap-4"
                    >
                      <div 
                        className="w-12 h-12 rounded-lg border border-border/20 flex items-center justify-center group-hover:scale-110 transition-transform"
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5 flex items-center gap-2">
                          <span className={`w-2 h-2 rounded-full ${
                            ...
                            project.status === 'On Hold' ? 'bg-amber-500' : 'bg-muted-foreground'
                          }`} />
                ...
                <div className="h-full flex flex-col items-center justify-center text-muted-foreground">
                  ...
                  <p className="text-xs mt-1 text-muted-foreground/80">İlk projenizi oluşturmak için sol taraftaki butonu kullanın</p>
                </div>
              )}
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-border flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-foreground">Hoş Geldiniz</span>
                  <span className="text-xs text-muted-foreground">T-Ecosystem Pro</span>
                </div>
              </div>
              <Button 
                variant="ghost" 
