              ...
              <>
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zinc-400">
                      We use cookies to ensure you get the best experience on Renderci. 
                      <button onClick={() => onOpenLegal('privacy')} className="text-pink-500 hover:underline ml-1">
                        Privacy Policy
                      </button>
                    </p>
                  </div>
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className="flex-1 px-4 py-2 bg-gradient-to-r from-pink-600 to-purple-600 hover:opacity-90 rounded-lg text-sm font-medium text-white transition-opacity"
                  >
                    Accept All
                  </button>
                </div>
              ...
              <>
                ...
                <div className="space-y-4 mb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-10 h-6 bg-pink-600/50 rounded-full relative opacity-50 cursor-not-allowed">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-zinc-500">Help us improve Renderci</span>
                    </div>
                    <button 
                         onClick={() => setPreferences(p => ({...p, analytics: !p.analytics}))}
                         title="Toggle Analytics"
                         className={cn("w-10 h-6 rounded-full relative transition-colors", preferences.analytics ? "bg-pink-600" : "bg-zinc-700")}
                    >
