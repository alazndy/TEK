...
export class MarketplaceService {
  private products: Module[] = [
    // --- UPH CORE (Main Hub) ---
    {
      ...
      longDescription:
        "UPH (Unified Project Hub), mühendislik ve üretim şirketleri için tasarlanmış kapsamlı bir proje yönetim platformudur. T-Ecosystem ailesinin merkezi uygulamasıdır. Projelerinizi, görevlerinizi, risklerinizi (RAID) ve mühendislik değişikliklerinizi (ECR/ECO) tek bir merkezden yönetmenizi sağlar.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Advanced charts, historical data, and energy predictions for Flux",
      longDescription:
        "Unlock the full power of your data with Flux Analytics Pro. This package adds predictive maintenance models and long-term trend analysis to your Flux installation.",
      benefits: [
    ...
    // --- FORGE (UPH Add-on Package) ---
    {
      ...
      description:
        "Manufacturing job tracking and technician assignment module.",
      longDescription:
        "Forge digitizes your manufacturing floor. Track production jobs, assign technicians, and monitor inventory consumption in real time. Designed for high-velocity manufacturing environments, Forge eliminates paper travelers and provides total visibility into your production pipeline.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Interactive 3D schematics for assembly technicians in Forge",
      longDescription:
        "Empower your technicians with interactive 3D models. Forge 3D Vision integrates CAD files directly into the job instruction panel, allowing workers to rotate, zoom, and explode assembly views.",
      benefits: [
    ...
    // ENV-I (Construction & Project Management)
    {
      ...
      longDescription:
        "ENV-I, mühendislik ve üretim şirketleri için tasarlanmış kapsamlı bir envanter yönetim sistemidir. Zon ve raf bazlı lokasyon takibi, seri numarası yönetimi ve akıllı stok uyarıları ile deponuzu tam kontrol altına alır.",
      benefits: [
    ...
    },
    {
      ...
      longDescription:
        "Master your project budget with standard Earned Value Management (EVM) capability. Track CPI, SPI, and forecast project completion costs with mathematical precision.",
      benefits: [
    ...
    // WEAVE (Supply Chain)
    {
      ...
      longDescription:
        "Weave, sistem seviyesinde bağlantı tasarım platformudur. Fiziksel ürünlerin (kameralar, monitörler, sensörler) birbirine nasıl bağlanacağını tasarlamak için kullanılır. ENV-I entegrasyonu ile ürünleri doğrudan sahneye çeker.",
      benefits: [
    ...
    },
    {
      ...
      longDescription:
        "Protect your supply chain from global disruption. Weave Risk AI monitors news, weather, and geopolitical events to alert you of potential impacts to your suppliers before they happen.",
      benefits: [
    ...
    // RENDERCI (Visualization)
    {
      ...
      longDescription:
        "Renderci Studio, teknik çizimlerden ve 3D modellerden yüksek kaliteli görsel renderlar üreten AI destekli bir motordur. Google Gemini Vision API ile sahneleri analiz eder ve prompt bazlı iyileştirme sağlar.",
      benefits: [
    ...
    },
    {
      ...
      longDescription:
        "Need more power? Kluster GPU Access connects your local Renderci Studio to our high-performance cloud GPU farm. Render scenes in minutes instead of hours.",
      benefits: [
    ...
    // T-SA (Audit)
    {
      ...
      longDescription:
        "T-SA (Technical Specification Analyzer), ihale şartnamelerini ve teknik dökümanları analiz eden AI tabanlı bir platformdur. PDF şartnameleri okur, gereksinimleri çıkarır ve ENV-I stokları ile otomatik eşleştirme yapar.",
      benefits: [
    ...
    // --- INTEGRATIONS (CROSS-APP) ---
    {
      ...
      longDescription:
        "Smart Link creates an intelligent bridge between Flux sensors and Forge maintenance tickets. When a sensor detects a fault, a job is automatically created in Forge with the correct error codes and machine location pre-filled.",
      description:
        "Auto-create maintenance jobs in Forge when Flux detects faults",
      benefits: [
    ...
    },
    {
      ...
      longDescription:
        "Connect construction demand with supply chain reality. EcoSync pushes material requirements from ENV-I project schedules directly into Weave maps, ensuring materials acturally arrive when they are needed on site.",
      description:
        "Sync construction material requirements directly to supply chain map",
      benefits: [
  ...
  create(createProductDto: CreateProductDto) {
    // Note: DTO is partial, so we cast to any for this mock or need full DTO
